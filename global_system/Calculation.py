    ...
    for element in grid.elements:
        ...
        for integration_point in range(4):
            ...
            for shape_fun_num in range(4):
                shape_fun_dx.append(calc_shape_fun_dx(uni_elem,
                                                      jacobians[integration_point],
                                                      integration_point,
                                                      shape_fun_num))
                shape_fun_dy.append(calc_shape_fun_dy(uni_elem, 
                                                      jacobians[integration_point],
                                                      integration_point,
                                                      shape_fun_num))
        ...
        for surf in range(element.amount_of_surface_with_bc):
            ...
            for integration_point in range(2):
                for shape_fun_vertic in range(4):
                    for shape_fun_horiz in range(4):
                        h_current[shape_fun_vertic][shape_fun_horiz] += GlDt.alfa \
                                                                        ...
                                                                        * det
                    p_current[shape_fun_vertic] += GlDt.alfa \
        ...
        for shape_fun_vertic in range(4):
            for shape_fun_horiz in range(4):
                h_global[element.nodes_id()[shape_fun_vertic]][element.nodes_id()[shape_fun_horiz]] += h_current[shape_fun_vertic][shape_fun_horiz]
